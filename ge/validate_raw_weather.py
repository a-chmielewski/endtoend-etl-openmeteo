...
def validate_weather_data(all_results: Dict[str, List[str]]) -> dict:
    ...
    print(f"Success percentage: {validation_results['statistics']['success_percent']:.2f}%")
...
if __name__ == "__main__":
    ...
    sample_results = {
        "Warsaw": ["s3://raw/weather/Warsaw/ds=2025-10-31/hour=12/openmeteo_20251031T120000.json"]
    }
